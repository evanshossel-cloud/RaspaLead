...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "surface-panel surface-panel-interactive rounded-xl text-card-foreground backdrop-blur-sm",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn("font-display text-xl font-black uppercase leading-none tracking-normal", className)}
    {...props}
  />
));
