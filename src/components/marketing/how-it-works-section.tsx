...
export function HowItWorksSection() {
  return (
    <section id="como-funciona" className="bg-[#fff8dc] px-4 py-16 text-black md:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <div className="max-w-3xl">
            <p className="text-sm font-black uppercase tracking-[0.18em] text-[#ff4fa3]">Como funciona</p>
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-4">
          {steps.map(({ title, description, icon: Icon }, index) => (
            <article key={title} className="relative rounded-[18px] border-4 border-black bg-white p-6 shadow-[8px_8px_0_#000]">
              <div className="mb-8 flex items-center justify-between">
                <span className="grid h-14 w-14 place-items-center rounded-full border-[3px] border-black bg-[#ffe34f] font-display text-2xl font-black">
                  {index + 1}
                </span>
