  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {[
          { label: "Leads visiveis", value: leads.length, icon: Users },
          { label: "Com telefone", value: leadsWithPhone, icon: Phone },
          { label: "Score 80+", value: hotLeads, icon: Target },
          {
            label: "Score medio",
        ...
        <Card className="overflow-hidden">
          <CardHeader className="border-b border-border/70 pb-4">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              <div>
                <CardTitle className="text-base">Lista operacional de leads</CardTitle>
                  ...
                  <CardContent className="space-y-4 p-4">
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        ...
                        <p className="mt-1 text-xs text-muted-foreground">{formatCityState(lead)}</p>
                      </div>
